...
# ZSH Configuration File: Created 9.8.18
...
plugins=(
  git zsh-syntax-highlighting zsh-autosuggestions python
)
...
POWERLEVEL9K_SHORTEN_DIR_LENGTH=1 # Show only the dir we are in 
#POWERLEVEL9K_LEFT_SEGMENT_SEPARATOR="\uE0C8"
POWERLEVEL9K_MODE='nerdfont-complete'
#sourcd $ZSH/oh-my-zsh.sh
